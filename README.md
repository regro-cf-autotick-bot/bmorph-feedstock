...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bmorph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13204&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bmorph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bmorph` can be installed with:

```
conda install bmorph
```

It is possible to list all of the versions of `bmorph` available on your platform with:
